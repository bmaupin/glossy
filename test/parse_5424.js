...
var withInvalidSD = '<165>1 2003-10-11T22:14:15.003Z mymachine.example.com evntslog - ID47 abc [exampleSDID@32473 iut="3" eventSource="Application" eventID="1011"] BOMAn application event log entry...';
syslogParser.parse(withInvalidSD, function(parsedMessage){
    var expectedData = {
        originalMessage: withInvalidSD,
        prival: 165,
        facilityID: 20,
        severityID: 5,
        facility: 'local4',
